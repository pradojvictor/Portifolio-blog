...
//https://api.github.com/users/pradojvictor/starred
...
const data = [
    {
        ...
        name: `prado`,
        img: `${images.image1}`,
        review: `deu certo esse teste`
    },
    {
        id: 2,
        name: `lima tested um nome grande demais`,
        img: `${images.image2}`,
        review: `deu certo esse teste tmb`
    },
    {
        id: 3,
        name: `pinheiro`,
        img: `${images.image3}`,
        review: `deu certo esse teste de novo To use a keyboard To use a keyboard shortcut to change between lowercase, UPPERCASE, and Capitalize Each Word, select the text and press SHIFT + F3 until the case you want is applied.shortcut to change between lowercase, UPPERCASE, and Capitalize Each Word, select the text and press SHIFT + F3 until the case you want is applied.`
    },
    {
        id: 4,
        name: `lima lima lima lima lima lima lima lima lima lima`,
        img: `${images.image2}`,
        review: `deu certo esse teste tmb eu certo esse teste tmbeu certo esse teste tmbeu certo esse teste tmbeu certo esse teste tmbeu certo esse teste tmbeu certo esse teste tmbeu certo esse teste tmbeu certo esse teste tmbeu certo esse teste tmb`
    },
    {
        id: 5,
        name: `pinheiro`,
        img: `${images.image3}`,
        review: `deu certo esse teste de novo`
    },
    {
        id: 6,
        name: `lima`,
